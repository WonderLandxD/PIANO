...
MIL_DEFAULT_PARAMS = {
    ...
    'dgrmil': {'dim_in': 1024, 'num_classes': 2, 'L': 1024, 'D': 128, 'n_lesion': 11, 'attn_mode': 'gated', 'dropout_node': 0.0, 'dropout_patch': 0.0, 'initialize': False, 'survival': False},
    ...
    'mambamil': {'dim_in': 1024, 'dim_hidden': 1024, 'num_classes': 2, 'dropout': 0.25, 'act': 'gelu', 'survival': False, 'layer': 2, 'rate': 10, 'type': 'SRMamba'},
