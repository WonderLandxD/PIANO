# Paper: CHIEF - Clinical Histopathology Imaging Evaluation Foundation Model, Nature 2024
# Code from https://github.com/hms-dbmi/CHIEF/tree/main

# Modified by Jiawen Li
...
class CHIEF(nn.Module):
    def __init__(self, gate=True, size_arg="large", word_embedding_path=None, dropout=True, n_classes=2,
